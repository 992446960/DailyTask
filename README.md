...
# 最新版本 2.4.0.0 —— 更新时间：2026年5月14日09点28分

1. 优化截图服务状态检测及边界处理
2. 优化任务列表获取下一个执行任务的时间计算方式，提升性能和线程安全
3. 优化倒计时服务的绑定和启动逻辑
4. 优化随机时间种子生成逻辑，保证每日随机时间一致性
5. 优化每日任务重置逻辑，避免整点不准确导致无法重置任务的问题
6. 优化全局配置项默认值，避免-1异常
7. 删除锁屏唤醒解锁及通知监听状态追踪功能
8. 新增省电模式开关以及低电量提醒功能
9. 新增节假日跳过任务执行功能
10. 新增内存使用监控预警
...
| 2.3.1.0 | 1. 删除通知记录功能（不影响指令`7`）<br>2. 优化指令`1`、`2`、`3`、`4`（语义微变，注意！！！）<br>3. 优化截图服务<br>4. 新增悬浮窗权限手动开启功能<br>5. 新增“悬浮权限”、“通知监听”、“截屏服务”三项核心服务无法手动关闭的提示<br>                                                                                                                                                                 |
